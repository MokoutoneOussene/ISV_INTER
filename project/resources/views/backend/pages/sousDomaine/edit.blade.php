...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <h5 class="card-title">Modification du competance N° {{$finds->id}}</h5>
            <!-- Vertical Form -->
            <form class="row g-3" method="POST" action="{{route('gestion_Sous_domaines.update', [$finds->id])}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="col-lg-6 col-md-12 mb-3">
                    <label for="inputNanme4" class="form-label">Domaine de compétence</label>
                    <select name="domaines_id" class="form-control">
